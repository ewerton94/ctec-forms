(function($) {
  ...
  $('#meal_preference').parent().append('<ul class="list-in-form" id="newmeal_preference" name="meal_preference"></ul>');
  $('#meal_preference option').each(function(){
      $('#newmeal_preference').append('<li class="choicelist-in-form" value="' + $(this).val() + '">'+$(this).text()+'</li>');
  });
